...
setwd("/Users/pialoettert/Documents/masterdesaster/masterarbeit/praediktoren/water_and_wetness/WAW_2018_010m_de_03035_v020/DATA/")
...
#mosiac tiles 
cop_waw_crop=mosaic(cop[[4]],cop[[5]], cop[[11]], cop[[12]], fun="mean")
mapview(cop_waw_crop) 
...
cop_waw_crop_proj=projectRaster(from=cop_waw_crop, crs=crs(umriss)) 

mapview(cop_waw_crop_proj) 
crs(cop_waw_crop_proj)

#mask
cop_waw_mask=mask(cop_waw_crop_proj, umriss)
mapview(cop_waw_mask) +mapview(umriss)
mapview(cop_waw_mask)

#save file
setwd("/Users/pialoettert/Documents/masterdesaster/masterarbeit/praediktoren/water_and_wetness/")
writeRaster(cop_waw_mask, filename = "water_and_wetness_crop_20221016.tif", 
            overwrite=T)
